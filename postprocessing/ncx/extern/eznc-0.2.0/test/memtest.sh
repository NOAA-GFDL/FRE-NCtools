...
TESTS="test_nc3 test_ezNc test_ezNcCompare test_ezNcCF test_ezNcBuffers test_ezNcCopySlabTask test_ezNcSlab test_ezNcSlabIterator test_ezNcSlicer test_ezNcUtil test_ezNcVariant test_ezPointerVector"
fi
