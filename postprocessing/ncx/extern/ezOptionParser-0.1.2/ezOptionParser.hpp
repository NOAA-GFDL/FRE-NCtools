...
/* ################################################################### */
bool isdigit(const std::string & s, int i=0) {
  int n = s.length();
  for(; i < n; ++i)
    switch(s[i]) {
...
/* ################################################################### */
void ToU1(std::string ** strings, unsigned char * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (unsigned char)atoi(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToS1(std::string ** strings, char * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (char)atoi(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToU2(std::string ** strings, unsigned short * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (unsigned short)atoi(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToS2(std::string ** strings, short * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (short)atoi(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToS4(std::string ** strings, int * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = atoi(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToU4(std::string ** strings, unsigned int * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (unsigned int)strtoul(strings[i]->c_str(), NULL, 0);
  }
};
/* ################################################################### */
void ToS8(std::string ** strings, long long * out, int n) {
  for(int i=0; i < n; ++i) {
...
/* ################################################################### */
void ToU8(std::string ** strings, unsigned long long * out, int n) {
  for(int i=0; i < n; ++i) {
    std::stringstream ss(strings[i]->c_str());
    ss >> out[i];
  }
...
/* ################################################################### */
void ToF(std::string ** strings, float * out, int n) {
  for(int i=0; i < n; ++i) {
    out[i] = (float)atof(strings[i]->c_str());
  }
};
/* ################################################################### */
void ToD(std::string ** strings, double * out, int n) {
  for(int i=0; i < n; ++i) {
...
/* ################################################################### */
void StringsToStrings(std::vector<std::string*> * strings, std::vector<std::string> * out) {
  for(int i=0; i < strings->size(); ++i) {
...
public:
  ezOptionValidator(const char* _type, const char* _op=0, const char* list=0, bool _insensitive=false);
  ezOptionValidator(char _type);
  ezOptionValidator(char _type, char _op, const char* list, int _size);
  ezOptionValidator(char _type, char _op, const unsigned char* list, int _size);
  ezOptionValidator(char _type, char _op, const short* list, int _size);
  ezOptionValidator(char _type, char _op, const unsigned short* list, int _size);
  ezOptionValidator(char _type, char _op, const int* list, int _size);
  ezOptionValidator(char _type, char _op, const unsigned int* list, int _size);
  ezOptionValidator(char _type, char _op, const long long* list, int _size);
  ezOptionValidator(char _type, char _op, const unsigned long long* list, int _size=0);
  ezOptionValidator(char _type, char _op, const float* list, int _size);
  ezOptionValidator(char _type, char _op, const double* list, int _size);
  ezOptionValidator(char _type, char _op, const char** list, int _size, bool _insensitive);
  ~ezOptionValidator();
...
private:
  // Auto increments to create unique IDs.
  static int ctr;
};
int ezOptionValidator::ctr = 0;
/* ------------------------------------------------------------------- */
...
public:
  ...
  void getInt(int&);
  void getLong(long&);
  void getLongLong(long long&);
  void getULong(unsigned long&);
  void getULongLong(unsigned long long&);
  void getFloat(float&);
...
public:
  ...
  void add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, ezOptionValidator* validator=0);
  void add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, ezOptionValidator* validator=0);
  void add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, ezOptionValidator* validator=0);
  void add(const char * defaults, bool required, int expectArgs, char delim, const char * help, const char * flag1, const char * flag2, const char * flag3, const char * flag4, ezOptionValidator* validator=0);
  ...
  bool gotValid(std::vector<std::string> & badOptions, std::vector<std::string> & badArgs);
