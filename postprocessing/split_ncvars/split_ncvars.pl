...
my $pkg_libexec_dir
    ...
    ? $ENV{PKGLIBEXECDIR}
    : '/Users/seth.underwood/Development/NOAA-GFDL/FRE-NCtools/test.and.source.cleanup/build/src/';
...
my $list_ncvars
    = defined( $ENV{LIST_NCVARS} ) ? $ENV{LIST_NCVARS} : "$pkg_libexec_dir/list_ncvars.csh";
