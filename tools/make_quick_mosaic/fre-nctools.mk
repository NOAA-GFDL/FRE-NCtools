#
# $Id: fre-nctools.mk,v 20.0 2013/12/14 00:33:35 fms Exp $
# ------------------------------------------------------------------------------
...
TARGETS  := make_quick_mosaic

SOURCES  := make_quick_mosaic.c
...
make_quick_mosaic: $(OBJECTS)
	$(CC) -o $@ $^ $(CLIBS)

make_quick_mosaic.o: make_quick_mosaic.c $(HEADERS)
