...
void cubic_spline_sp_acc(int size1, int size2, const double *grid1, const double *grid2, const double *data1,
                  double *data2 )
{
...
void cubic_spline_acc(int size1, int size2, const double *grid1, const double *grid2, const double *data1,
...
/*------------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
void conserve_interp_acc(int nx_src, int ny_src, int nx_dst, int ny_dst, const double *x_src,
...
/*------------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
void conserve_interp_great_circle_acc(int nx_src, int ny_src, int nx_dst, int ny_dst, const double *x_src,
		     const double *y_src, const double *x_dst, const double *y_dst,
		     const double *mask_src, const double *data_src, double *data_dst )
{
  int n, nxgrid;
...
void linear_vertical_interp_acc(int nx, int ny, int nk1, int nk2, const double *grid1, const double *grid2,
