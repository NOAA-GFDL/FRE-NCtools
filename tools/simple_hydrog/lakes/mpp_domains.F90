...
!***********************************************************************
  ...
  integer(LONG_KIND), parameter :: GT_BASE=int(Z'0000000000000100', KIND=LONG_KIND)  ! Workaround for 64bit int init problem

  !     integer(LONG_KIND), parameter :: KE_BASE=2**48
  integer(LONG_KIND), parameter :: KE_BASE=int(Z'0001000000000000', KIND=LONG_KIND)  ! Workaround for 64bit int init problem
