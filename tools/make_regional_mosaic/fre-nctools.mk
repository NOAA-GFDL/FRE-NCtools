#
# $Id: fre-nctools.mk,v 20.0 2013/12/14 00:33:42 fms Exp $
# ------------------------------------------------------------------------------
...
TARGETS  := make_regional_mosaic

SOURCES  := make_regional_mosaic.c
...
make_regional_mosaic: $(OBJECTS) mosaic_util.o mpp.o
	$(CC) -o $@ $^ $(CLIBS)
