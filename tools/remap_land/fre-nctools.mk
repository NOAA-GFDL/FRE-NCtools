#
# $Id: fre-nctools.mk,v 20.0 2013/12/14 00:35:06 fms Exp $
# ------------------------------------------------------------------------------
...
CLIBS     := $(LDFLAGS) -L${NETCDF_HOME}/lib -L${HDF5_HOME}/lib -lnetcdf -lhdf5_hl -lhdf5 -lz -limf $(CLIBS_SITE) $(STATIC)

TARGETS  := remap_land remap_land_parallel

SOURCES  := remap_land.c
...
remap_land: $(OBJECTS) mosaic_util.o mpp.o
	$(CC) -o $@ $^ $(CLIBS)

remap_land_parallel: $(OBJECTS) mosaic_util_parallel.o mpp_parallel.o
	$(MPICC) -o $@ $^ $(CLIBS)
